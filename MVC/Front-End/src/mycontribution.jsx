...
class QPerPeriod extends Component {
    ...
    initialGetMetricsAns = async (event) => {
        try {
            const {data: answers} = await axios({
                method: 'get',
                url: "http://localhost:3001/myansmetricscontribution",
    ...
    initialGetMetricsQ = async (event) => {
        try {
            const {data: questions} = await axios({
                method: 'get',
                url: "http://localhost:3001/myqmetricscontribution",
        ...
        console.log(this.state.questionMetrics)
    ...
    initialGetAnswers = async (event) => {
        try {
            const {data: answers} = await axios({
                method: 'get',
                url: "http://localhost:3001/myanscontribution",
    ...
    componentDidMount = async (event) => {
        ...
        try {
            const {data: questions} = await axios({
                method: 'get',
                url: "http://localhost:3001/myqcontribution",
